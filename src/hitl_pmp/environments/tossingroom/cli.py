...
class TossingRoomCli:
    ...
    def add_arguments(*, parser: argparse.ArgumentParser) -> None:
        ...
        # coefficient is the force per unit away from that reference. Exposed because
        # together with --throw-tolerance these are what set how hard the sampler's job
        # is, and a difficulty sweep should not need a code edit.
        parser.add_argument(
            "--reference-force",
            type=float,

...
from .problem import TossingRoomSplitProblem
from .renderer import TossingRoomSplitRenderer
from .skill_provider import TossingRoomSplitOracle, TossingRoomSplitSkillProvider
from .tasks import TossingRoomSplitGoalType, TossingRoomSplitTasks


class TossingRoomSplitCli:
    ...
    def add_arguments(*, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            "--goal-type",
            choices=[goal_type.value for goal_type in TossingRoomSplitGoalType],
            default=None,

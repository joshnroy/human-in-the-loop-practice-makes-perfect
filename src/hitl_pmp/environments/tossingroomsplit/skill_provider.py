...
from .skills import TossingRoomSplitSkills


class TossingRoomSplitSkillProvider(SkillProvider):
    """This domain's `SkillProvider`: exposes `TossingRoomSplitSkills` and this domain's
    ...
    def skills(self) -> tuple[Skill, ...]:
        return (
            TossingRoomSplitSkills.PICKUP_TRASH,
            TossingRoomSplitSkills.PICKUP_RECYCLING,
            TossingRoomSplitSkills.MOVE_ROOM,
            TossingRoomSplitSkills.THROW_TRASH,
            TossingRoomSplitSkills.THROW_RECYCLING,
            TossingRoomSplitSkills.PRESS_TRASH,
            TossingRoomSplitSkills.PRESS_RECYCLING,
        )
    ...
    def types(self) -> tuple[Type, ...]:
        return (
            TossingRoomSplitEnvironment.robot_type,
            ...
            TossingRoomSplitEnvironment.trash_button_type,
            TossingRoomSplitEnvironment.recycling_button_type,
            TossingRoomSplitEnvironment.trash_type,
            TossingRoomSplitEnvironment.recycling_type,
            TossingRoomSplitEnvironment.pile_type,
        )
    ...
    def sample_params(self, *, ground_skill: GroundSkill, rng: np.random.Generator) -> np.ndarray:
        return TossingRoomSplitSkills.sample_params(ground_skill=ground_skill, rng=rng)

    def compute_action(
        self, *, ground_skill: GroundSkill, params: np.ndarray, state: State
    ) -> Action:
        return TossingRoomSplitSkills.compute_action(
            ground_skill=ground_skill, params=params, state=state
        )


class TossingRoomSplitOracle(OraclePolicyProvider):

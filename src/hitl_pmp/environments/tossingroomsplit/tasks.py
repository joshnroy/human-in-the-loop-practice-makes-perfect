...
class TossingRoomSplitTasks(Tasks):
    ...
    Each task draws per-item throw targets (Uniform[target_low, target_high)) -- the
    continuous per-episode value the throw samplers specialize on. The two streams

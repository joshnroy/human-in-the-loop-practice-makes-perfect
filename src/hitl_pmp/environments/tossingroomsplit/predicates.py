...
`tests/environments/tossingroomsplit/test_skills.py` asserts a cross-kind grounding is
...
class ItemInBinClassifier:
    ...
    the item. A bin holds at most one item (`TossingRoomSplitEnvironment.BIN_CAPACITY`)
...
ROBOT_IN_ROOM = Predicate(
    name="RobotInRoom",
    types=(TossingRoomSplitEnvironment.robot_type, TossingRoomSplitEnvironment.room_type),
...
HAND_EMPTY = Predicate(
    name="HandEmpty",
    types=(TossingRoomSplitEnvironment.robot_type,),
    holds=lambda state, objects: HandEmptyClassifier.holds(state=state, robot=objects[0]),
)

HOLDING_TRASH = Predicate(
    name="HoldingTrash",
    types=(TossingRoomSplitEnvironment.robot_type, TossingRoomSplitEnvironment.trash_type),
...
HOLDING_RECYCLING = Predicate(
    ...
    types=(TossingRoomSplitEnvironment.robot_type, TossingRoomSplitEnvironment.recycling_type),
    holds=lambda state, objects: HoldingClassifier.holds(
        state=state, robot=objects[0], item=objects[1]
    ),
)
...
ADJACENT = Predicate(
    name="Adjacent",
    types=(TossingRoomSplitEnvironment.room_type, TossingRoomSplitEnvironment.room_type),
...
TRASH_IN_BIN = Predicate(
    name="TrashInBin",
    types=(TossingRoomSplitEnvironment.trash_type, TossingRoomSplitEnvironment.trash_bin_type),
...
RECYCLING_IN_BIN = Predicate(
    name="RecyclingInBin",
    types=(
        TossingRoomSplitEnvironment.recycling_type,
...
TRASH_BIN_EMPTY = Predicate(
    name="TrashBinEmpty",
    types=(TossingRoomSplitEnvironment.trash_bin_type,),
...
RECYCLING_BIN_EMPTY = Predicate(
    ...
    types=(TossingRoomSplitEnvironment.recycling_bin_type,),
    holds=lambda state, objects: BinEmptyClassifier.holds(state=state, bin_obj=objects[0]),
)

TRASH_BIN_IN_ROOM = Predicate(
    name="TrashBinInRoom",
    types=(TossingRoomSplitEnvironment.trash_bin_type, TossingRoomSplitEnvironment.room_type),
...
RECYCLING_BIN_IN_ROOM = Predicate(
    ...
    types=(TossingRoomSplitEnvironment.recycling_bin_type, TossingRoomSplitEnvironment.room_type),
    holds=lambda state, objects: BinInRoomClassifier.holds(
        state=state, bin_obj=objects[0], room=objects[1]
    ),
)
...
PILE_IN_ROOM = Predicate(
    name="PileInRoom",
    types=(TossingRoomSplitEnvironment.pile_type, TossingRoomSplitEnvironment.room_type),
...
TRASH_BUTTON_IN_ROOM = Predicate(
    ...
    types=(TossingRoomSplitEnvironment.trash_button_type, TossingRoomSplitEnvironment.room_type),
...
RECYCLING_BUTTON_IN_ROOM = Predicate(
    ...
    types=(
        TossingRoomSplitEnvironment.recycling_button_type,
        TossingRoomSplitEnvironment.room_type,
    ),
    holds=lambda state, objects: ButtonInRoomClassifier.holds(
        state=state, button=objects[0], room=objects[1]
    ),

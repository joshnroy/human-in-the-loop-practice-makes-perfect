...
class TossingRoomSplitSkills:
    ...
    **The one difference from `TossingRoomSkills`, and the reason this domain exists**:
    ...
    _robot: ClassVar[Variable] = Variable(name="robot", type=TossingRoomSplitEnvironment.robot_type)
    _trash: ClassVar[Variable] = Variable(name="trash", type=TossingRoomSplitEnvironment.trash_type)
    _recycling: ClassVar[Variable] = Variable(
        name="recycling", type=TossingRoomSplitEnvironment.recycling_type
    )
    _room: ClassVar[Variable] = Variable(name="room", type=TossingRoomSplitEnvironment.room_type)
    _from_room: ClassVar[Variable] = Variable(
        name="from_room", type=TossingRoomSplitEnvironment.room_type
    )
    _to_room: ClassVar[Variable] = Variable(
        name="to_room", type=TossingRoomSplitEnvironment.room_type
    )
    _trash_bin: ClassVar[Variable] = Variable(
        name="trash_bin", type=TossingRoomSplitEnvironment.trash_bin_type
    )
    _recycling_bin: ClassVar[Variable] = Variable(
        name="recycling_bin", type=TossingRoomSplitEnvironment.recycling_bin_type
    )
    _trash_button: ClassVar[Variable] = Variable(
        name="trash_button", type=TossingRoomSplitEnvironment.trash_button_type
    )
    _recycling_button: ClassVar[Variable] = Variable(
        name="recycling_button", type=TossingRoomSplitEnvironment.recycling_button_type
    )
    _pile: ClassVar[Variable] = Variable(name="pile", type=TossingRoomSplitEnvironment.pile_type)
    ...
    def compute_action(*, ground_skill: GroundSkill, params: np.ndarray, state: State) -> Action:
        ...
        `TossingRoomSplitEnvironment`); the kind is carried in `arg` and read off a bound
        object's own `kind` feature, so the two branches of each pair differ only in
        which object they read."""
        skills = TossingRoomSplitSkills

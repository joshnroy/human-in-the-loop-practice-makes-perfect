...
def test_build_initial_state_places_bins_and_buttons_in_their_rooms() -> None:
    ...
    assert state.get(obj=TossingRoomSplitEnvironment.trash, feature_name="target_force") == 0.7
    assert state.get(obj=TossingRoomSplitEnvironment.recycling, feature_name="target_force") == 0.3

...
> `2026-08-07-pickup-weight-reset-free-ab.md` repeats this exact protocol on the
> corrected domain (then named `tossingroomsplitpickupweight`, now `tossingroom`). Read that page for the current answer. This

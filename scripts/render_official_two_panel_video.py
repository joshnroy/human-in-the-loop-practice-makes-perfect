...
- Controller: MultiStagePickCubeController (Stage 1: Transit to z+12cm -> Stage 2: Align Wrist Yaw in Air -> Stage 3: Vertical Descent -> Clamp -> Toss)
...
def render_official_video(seed=103, output_dir=Path("docs/official_two_panel_videos")):
    ...
    def capture_frame(phase_title):
        ...
        d.text((20, 6), "MULTI-STAGE WAYPOINT CONTROLLER (Pre-Grasp High ──> Vertical Descent) [1/2 SPEED]", fill=(100, 255, 100), font=font_large)
        d.text((20, 28), "1. Transit above cube (z+12cm) -> 2. Align wrist yaw in air -> 3. Pure vertical descent -> 4. Clamp & Toss", fill=(180, 220, 180), font=font_small)
        ...
        d.text((20, total_h - 35), "Photorealistic MimicLabs Lab2 Shading & Textures | Kinova Gen3 on TidyBot Base | Seed 103", fill=(255, 230, 120), font=font_small)

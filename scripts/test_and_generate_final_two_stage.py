...
- Right Panel: Original default camera view (task_view) with realistic textures & lighting (scene_bg=True)
    ...
    def reset(self, x, params=None):
        ...
        for rotation in rotations:
            ...
            try:
                ...
                self._setup_trajectories(upright, rotation)
                return
            except Exception:
                continue
...
def render_final_video(seed=103, output_dir=Path("docs/clean_two_stage_videos")):
    ...
    def capture_frame(phase_title):
        ...
        d.text((20, 28), "1. Move to z+10cm & STOP -> 2. Pure vertical descent & STOP -> 3. Center Clamp & Toss", fill=(180, 220, 180), font=font_small)

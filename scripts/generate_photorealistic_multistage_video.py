    ...
    def reset(self, x, params=None):
        ...
        for rotation in rotations:
            ...
            try:
                ...
                self._setup_waypoints(upright, rotation)
                return
            except Exception:
                continue
...
def render_photorealistic_video(seed=103, output_dir=Path("docs/photorealistic_videos")):
    ...
    def capture_frame(phase_title):
        ...
        d.text((20, 6), "MULTI-STAGE WAYPOINT CONTROLLER (With Standstill Settle Stops) [1/2 SPEED]", fill=(100, 255, 100), font=font_large)
        d.text((20, 28), "1. Move to z+12cm & STOP -> 2. Align Wrist Yaw & STOP -> 3. Straight Vertical Descent & STOP -> 4. Clamp & Toss", fill=(180, 220, 180), font=font_small)
